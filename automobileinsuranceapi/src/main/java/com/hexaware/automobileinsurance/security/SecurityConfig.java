 ...
 * - CORS enabled for the local React dev server(s)
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    /**
     * Allows the React dev server (Vite default ports) to call this API
     * from the browser. Adjust the allowed origins here if you deploy
